...
for(const file of ['regularticket26.html','vipticket26.html','regularticketlt.html','vipticketlt.html']) {
 ...
 for(const scenario of [
  ...
  {query:'',cookie:'_fbc=fb.1.1720000000000.click-id',fallback:{},ready:true,campaign:null,fbc:'fb.1.1720000000000.click-id'},
  ...
  assert.equal(u.searchParams.get('fbc'),scenario.fbc||null);
